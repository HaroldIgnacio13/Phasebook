...
5. Install the dependencies using the following command:
    ...
    ```
6. Install the numba pakage that is make the built in function more faster
    ```
    pip install numba
    ```
7. Run the application with the command:
    ...
    ```
8. Open the url printed on the terminal: `http://127.0.0.1:5000` using your browser or a tool like [Postman](https://www.postman.com). You should get a text saying `Hello World!`.
